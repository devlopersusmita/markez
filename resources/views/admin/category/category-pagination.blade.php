    ...
    <table id="example1_123" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            <tr >
                ...
                <td>
                    <table><tr><td> <span   class="btn btn-info categoryview_modal"  data-toggle="modal" data-target="#modals-view" style="cursor: pointer;" data-id="<?php echo $category['id']?>" >View</span></td><td> <span   class="btn btn-warning categoryedit_modal" data-toggle="modal" data-target="#categorymodals-edit" style="cursor: pointer;" data-id="<?php echo $category['id']?>" >Edit</span></td><td><span    class="btn btn-danger delete_modal" data-toggle="modal" data-target="#modals-delete" style="cursor: pointer;" data-id="<?php echo $category['id']?>" >Delete</span></td></tr></table>
