                                ...
                                <div class="shop-header">
                                    <div class="container">
                                        <div class="store-tabs max_width_80_percent">
                                            <a data-tab="public-tab" class="tab-control is-active">Public (My Institution)</a>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("studentinstitution")}}' id='search_btn_public_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_public_it">
                                                    @include("theme.student.institution-public-pagination",['public'=>$public])
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                     ...
                                                     <div class="header-inner padding_top_10">
                                                        ...
                                                        <form id="searchform_private_pending_it" name="searchform_private_pending" >
                                                    <div class="field is-grouped">
                                                        <div class="control" >
                                                            <input type="text" name="name" class="input" placeholder="name" />
                                                        </div>
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("studentinstitution")}}' id='search_btn_private_pending_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_pending_it">
                                                    @include("theme.student.institution-private-pending-pagination",['private_pending'=>$private_pending])
                                                </div>
                                            </div>
                                            ...
                                            <div class="groups-grid padding_0">
                                                ...
                                                <div class="grid-header">
                                                     ...
                                                     <div class="header-inner padding_top_10">
                                                        ...
                                                        <form id="searchform_private_sending_it" name="searchform_private_sending" >
                                                    <div class="field is-grouped">
                                                        <div class="control" >
                                                            <input type="text" name="name" class="input" placeholder="name" />
                                                        </div>
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("studentinstitution")}}' id='search_btn_private_sending_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_sending_it">
                                                    @include("theme.student.institution-private-sending-pagination",['private_sending'=>$private_sending])
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                     ...
                                                     <div class="header-inner padding_top_10">
                                                        ...
                                                        <form id="searchform_private_receiving_it" name="searchform_private_receiving" >
                                                    <div class="field is-grouped">
                                                        <div class="control" >
                                                            <input type="text" name="name" class="input" placeholder="name" />
                                                        </div>
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("studentinstitution")}}' id='search_btn_private_receiving_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_receiving_it">
                                                    @include("theme.student.institution-private-receiving-pagination",['private_receiving'=>$private_receiving])
                                                </div>
                                            </div>
                                            </div>
                                        </div>
            ...
            <span aria-hidden="true">&times;</span>
                  ...
                  <div class="card-footer">
                      ...
                      <div class="button-wrap" style="width: 100%;">
                          ...
                          <div style="float:right;display:none;" id="loading_institution_approvet_it"><img src="{{asset('frontend/images/loadingpleasewait.gif')}}" width="40" /></div>
            ...
            <span aria-hidden="true">&times;</span>
                          ...
                          <div class="featured-image">
                            <div class="alert" role="alert">
                                   <p style="text-align:center;">Are you sure?</p>
                                    <h6  style="text-align:center;" class="alert-heading">Warning!</h6>
                                  <div class="alert-body">
                                  Do you really want to send request to Institution
                                  </div>
                             </div>
                  ...
                  <div class="card-footer">
                      ...
                      <div class="button-wrap" style="width: 100%;">
                          ...
                          <button data-dismiss="modal" aria-label="Close" class="button is-solid dark-grey-button close-modal">Cancel</button>
                          <button  type="submit"  class="button is-solid primary-button data-delete institution_send_it">Confirm Send</button>
                          <div style="float:right;display:none;" id="loading_institution_send_it"><img src="{{asset('frontend/images/loadingpleasewait.gif')}}" width="40" /></div>
