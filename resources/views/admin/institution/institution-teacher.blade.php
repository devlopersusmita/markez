            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6">
                    ...
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Institution  Teacher</li>
    ...
    <section class="content">
        <div class="container-fluid">
         ...
         <div id="pagination_data">
            @include("admin.institution.institution-teacher-pagination",['institution_teachers'=>$institution_teachers])
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header">
          <h5 class="modal-title" >Institution Teacher</h5>
