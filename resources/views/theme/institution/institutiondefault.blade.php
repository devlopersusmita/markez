                             ...
                             if(data_exist=='1'){
                                 ...
                                 htmlcont=htmlcont+'</tr>';
                                  ...
                                  if(data.price==0){
                                     ...
                                     htmlcont=htmlcont+'</td>';
                                     htmlcont=htmlcont+'<td>';
                                     htmlcont=htmlcont+' <a class="button is-solid accent-button " href="'+baseurl + '/coursesubscription/'+id+'institution_id={{$_GET['institution_id']}}&user_id={{$_GET['user_id']}}`'+'">Pay</a>';
                                     htmlcont=htmlcont+'</td>';
                                     htmlcont=htmlcont+'</tr>';
                                  }
