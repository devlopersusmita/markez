...
<div class="app-main__outer">
   <div class="app-main__inner">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="table-responsive category-table banner-setting">
          <table class="table">
            <thead>
              <th>Slider</th>
              <th>Slider Header</th>
              <th class="bannersetting_content">Slider Text</th>
              <th class="bannersetting_content">Description</th>
              <th>Link</th>
 ...
 <div class="modal fade" id="modals-view" tabindex="-1" aria-hidden="true">
  ...
  <!-- Modal to view Home setting Ends-->
    ...
    <div class="modal common-modal fade" id="homemodals-edit" tabindex="1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
             <div class="modal-header">
            ...
            <div class="modal-body p-3">
             ...
             <button type="submit" id="homesetting_edit" class="btn btn-success data-edit data-add">Save</button>
              <button data-dismiss="modal" aria-label="Close" class="btn btn-outline-secondary data-cancel" >Cancel</button>
              </form>
