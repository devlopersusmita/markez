                 ...
                 <div class="column">
                     ...
                     <div class="profile-about side-menu">
                         ...
                         <div class="right-content">
                            ...
                            <h3>Subscription Not Accessible for You ! Please Extended the subscription date<br>Your latest date of subscription was {{date('Y-m-d',strtotime($user_details->subscription_end_date))}} <br><a href="{{Route('subcription')}}">Extend Subcription</a></h3>
