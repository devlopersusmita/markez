...
<div class="card-body  table-responsive">
    ...
    <table  width="100%" class="table table-border table-striped">
        ...
        <tbody>
            ...
            @foreach($private_sending as $institution)
            <tr >
                ...
                <td>
                    <span   class="button is-solid green-button raised send_modal_it" data-toggle="modal" data-target="#modals-send_it" style="cursor: pointer;"data-id="<?php echo $institution['id']?>" data-type="private_sending" >Send Request</span>
...
<div id="pagination_private_sending_it">
