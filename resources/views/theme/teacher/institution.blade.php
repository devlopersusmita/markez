                                ...
                                <div class="shop-header">
                                    <div class="container">                      
                                        <div class="store-tabs max_width_80_percent">
                                            <a data-tab="public-tab" class="tab-control is-active">Public (My Institutions)</a>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("teacherinstitution")}}' id='search_btn_public_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_public_it">
                                                    @include("theme.teacher.institution-public-pagination",['public'=>$public])
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("teacherinstitution")}}' id='search_btn_private_pending_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_pending_it">
                                                    @include("theme.teacher.institution-private-pending-pagination",['private_pending'=>$private_pending])
                                                </div>
                                            </div>
                                            ...
                                            <div class="groups-grid padding_0">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("teacherinstitution")}}' id='search_btn_private_sending_it'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_sending_it">
                                                    @include("theme.teacher.institution-private-sending-pagination",['private_sending'=>$private_sending])
                                                </div>
                                            </div>
