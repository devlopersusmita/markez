...
public function attendancestore(Request $request,$id,$online_class_id)
{
   ...
   public function index(Request $request,$id,$content_id)
    ...
    public function store(Request $request)
    {
        ...
        if (!$user) {
            // Handle the case when the Zoom user is not found.
            return redirect()->back()->with('error', 'Zoom user not found')->withInput();
        }
        ...
        $onlineClass->user_id = $created_by;
        ...
        if ($onlineClass->save()) {
            ...
            Session::flash('error', 'Something went wrong while saving the online class.');
            return response()->json(['message' => 'Something went wrong while saving the online class.']);
        }
    }
    /**
