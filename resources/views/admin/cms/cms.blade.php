        ...
        <div class="container-fluid">
            <div class="card">
             ...
             <div class="row">
                ...
                <div class="col-md-6 "><a  class="btn btn-primary float-right add_modal" data-toggle="modal" data-target="#modals-add" style="cursor: pointer;"><i class="fa fa-plus"></i> New Cms</a></div>
                        ...
                        <div class="col-md-4" style="float: right;">
                               ...
                               <div class="input-group mb-3">
                                      ...
                                      <div class="input-group-append">
                                        ...
                                        <a class='btn btn-info' href='{{Route("cms")}}' id='search_btn'>Search</a>
                                      </div>
                                    </div>
         ...
         <div id="pagination_data">
            @include("admin.cms.cms-pagination",['cmses'=>$cmses])
          </div>
...
@endsection
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
           <div class="modal-header">
             <h5 class="modal-title" >New Cms </h5>
          ...
          <div class="modal-body p-3 pt-0">
            <form class="add-new-cms"   enctype="multipart/form-data" >
             <div class="row">
                <div class="col-md-12">
                    <label>Title</label>
           ...
           <button type="submit" id="cms_add" class="btn btn-success data-add">Save</button>
 ...
 <!-- Modal to edit new Cms starts-->
    <div class="modal fade" id="modals-edit" tabindex="1" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
           <div class="modal-header">
             <h5 class="modal-title" >Edit Cms </h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-body p-3 pt-0">
            <form class="edit-new-cms"   enctype="multipart/form-data" >
             <div class="row">
                <div class="col-md-12">
                    <label>Title</label>
           ...
           <button type="submit" id="cms_edit" class="btn btn-success data-edit">Save</button>
            <button data-dismiss="modal" aria-label="Close" class="btn btn-outline-secondary" >Cancel</button>
            </form>
 ...
 <!-- Modal to view Cms starts-->
    ...
    <!-- Modal to view new Cms Ends-->

      <!-- Modal to delete Cms start-->
    <div class="modal fade" id="modals-delete" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
           <div class="modal-header">
            <h5 class="modal-title" >Delete Cms</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-body p-3 pt-0">
            ...
            <div class="alert alert-warning" role="alert">
              ...
              <div class="col-sm-12 ps-sm-0">
                ...
                <button type="submit" id="cms_delete" class="btn btn-danger data-delete">Delete</button>
                 <button data-dismiss="modal" aria-label="Close" class="btn btn-outline-secondary" >Cancel</button>
              </div>
    ...
    <!-- Modal to delete Cms Ends-->


 <!-- Modal to statuschange Cms start-->
    <div class="modal fade" id="modals-statuschange" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
           <div class="modal-header">
            <h5 class="modal-title" >Cms Status Change</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          ...
          <div class="modal-body p-3 pt-0">
            ...
            <div class="alert" role="alert">
              ...
              <h6 class="alert-heading">Warning!</h6>
              <div class="alert-body">
                Do you really want to change this status as <span class="alert " id="cms_status_span"> </span>
              </div>
            </div>
              ...
              <div class="col-sm-12 ps-sm-0">
                ...
                <button type="submit" id="cms_statuschange" class="btn btn-danger data-delete">Save</button>
                <button data-dismiss="modal" aria-label="Close" class="btn btn-outline-secondary" >Cancel</button>
              </div>
    ...
    <!-- Modal to statuschange Cms Ends-->
