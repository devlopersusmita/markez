...
public function courseView($id)
{
    ...
    return json_encode(array('status'=>'ok','data'=>$courses,'course_teachers_user_id'=>$course_teachers_user_id,'category_name'=>$category_name,'course_teacher_ids'=>$course_teacher_id,'asset'=>asset('')));
