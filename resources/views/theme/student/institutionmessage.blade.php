                    ...
                    <div class="groups-grid padding_0">
                        ...
                        <div class="grid-header">
                            <div class="header-inner">
                                <h2>Message Inbox(Institution)</h2>
                                ...
                                <div class="message-left-side">
                                     <div class="field">
                                        ...
                                        <div class="control has-icon">
                                            <input type="text" class="input" id="institution_search_text">
                                            <div class="form-icon">
                                    ...
                                    <div class="box-content">
                                        <div class="box-subscribers" style="padding-left:30px;">
                                            <div class="box-subscriber" >
                                                <div id="institution_logo">

                                                </div>
                                                <div class="subscriber-meta">
                                                    <span class="meta-title" id="institution_name"></span>
                                                </div>
                                            </div>
                                        </div>
