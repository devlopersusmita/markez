                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("institutionstudent")}}' id='search_btn_public'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_public">
                                                    @include("theme.institution.student-public-pagination",['public'=>$public])
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("institutionstudent")}}' id='search_btn_private_pending'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_pending">
                                                    @include("theme.institution.student-private-pending-pagination",['private_pending'=>$private_pending])
                                                </div>
                                            </div>
                                            ...
                                            <div class="groups-grid padding_0">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("institutionstudent")}}' id='search_btn_private_sending'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_sending">
                                                    @include("theme.institution.student-private-sending-pagination",['private_sending'=>$private_sending])
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-card">
                                                ...
                                                <div class="grid-header">
                                                    ...
                                                    <div class="field is-grouped">
                                                        ...
                                                        <div class="control" >
                                                            <a class="button is-solid primary-button raised"  href='{{Route("institutionstudent")}}' id='search_btn_private_receiving'>Search</a>
                                                        </div>
                                                    </div>
                                                   </form>
                                             ...
                                             <div id="overview-content" class="content-section is-active">
                                                ...
                                                <div id="pagination_data_private_receiving">
                                                    @include("theme.institution.student-private-receiving-pagination",['private_receiving'=>$private_receiving])
                                                </div>
                                            </div>
                                            </div>
                                        </div>
          ...
          <span aria-hidden="true">&times;</span>
                ...
                <div class="card-footer">
                    ...
                    <div class="button-wrap" style="width: 100%;">
                        ...
                        <div style="float:right;display:none;" id="loading_student_approve"><img src="{{asset('frontend/images/loadingpleasewait.gif')}}" width="40" /></div>
